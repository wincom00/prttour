...
<html lang="en">
    <head>
		...
		<!-- purun js -->
			<script src="/js/purun.js?sid=20260324-available-date"></script>
	...
	<script>
        ...
        setInterval(function(){
            ...
            if (clockEl) clockEl.innerHTML = chan_val+" "+h + ":" + m + ":" + s;
        },1000);
    </script>
        ...
        <div class="style_switcher">
			...
			<div class="sepH_c">
				...
				<div class="clearfix">
					...
					<label class="radio-inline"><input name="ssw_layout" id="ssw_layout_fixed" value="gebo-fixed" type="radio"> Fixesd</label>
				</div>
			</div>
			<div class="sepH_c">
