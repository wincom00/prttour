<?php
    ...
    $reserve_info = getMusicalReserveSelfinfo($r_code);
...
<body>
	...
	<div id="contentwrapper" class="reservationDetailForm">
			...
			<div class="row">
				<div class="col-sm-12">
					<form action="<?= $PHP_SELF ?>?division=<?=$division?>&pdx=<?=$pdx?>&sub=<?=$sub?>&r_code=<?=$reserve_info['reserveCode']?>" name="frmpayment" id="frmpayment" method="post">
								<input type="hidden" name="mode" value="paymentProcess">
								<input type="hidden" name="hcode" value="<?= $reserve_info['total_amount'] ?>">
								<input type="hidden" name="lasttotal" value="<?=$reserve_info['total_amount']?>">
						        <input type="hidden" name="lastbalance" id="lastbalance" value="<?=$reserve_info['balance']?>">
								
								<input type="hidden" name="hname" value='<?= $reserve_info['h_name'] ?>'>
										...
										<table class="table table-bordered table-condensed gridSixteen paymentProcessingTable formDetail">
											<tbody>
												<tr>
													...
													<td colspan="2"><?=$reserve_info['member_name']?></td>
													<td colspan="2" class="active text-center formHeader">인원</td>
													<td colspan="2" class="text-center"><?=$reserve_info['member_adult']?></td>
												</tr>
												<tr>
													<td colspan="2" class="active text-center formHeader">관람명</td>
													<td colspan="6">[<?=$reserve_info['h_code']?>] <?=$reserve_info['h_name']?></td>
													<td colspan="2" class="active text-center formHeader">관람일</td>
													<td colspan="6"><?=$reserve_info['act_date']?>-<?=$reserve_info['act_time']?></td>
												</tr>
												<tr>
													<td colspan="2" class="active text-center formHeader">총금액</td>
													<td colspan="6"><span id="lastpay"><?=$sign?> <?=$reserve_info['total_amount']?></span></td>
													<td colspan="2" class="active text-center formHeader">잔금</td>
													<td colspan="6"><span id="balpay"><?=$sign?> <?=$reserve_info['balance']?></span></td>
												</tr>
											</tbody>
										</table>
										<table class="table table-bordered table-condensed gridSixteen paymentProcessingTable formDetail">
