<?php
    ...
    */
	function printConsult(){
			...
			if ($employeeName) {
					$qryemp = " && (register='$employeeName' || t_memeber='$employeeName')";
			...
			$qry1 = "select *
				from 
					consult_info
				where 1=1 $qrysdate $qryemp group by p_code, member_name,member_phone,member_email order by wdate,consultCode desc
