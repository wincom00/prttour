		...
		<div class="row">
				<div class="col-sm-12 col-md-12">
					   <form Enctype="multipart/form-data" name=board_write id=board_write action=<?= $PHP_SELF ?> method=post onSubmit="return chk(this)">
								  <input type=hidden name=board_mode value="modify_write">
								 ...
								 <table class="table table-striped table-bordered mediaTable" width="100%" >
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <?php
											...
											$cr_qry1 = "select * from code_base where lvcode1 = 'G01' && lvcode2 <> '00'  order by lvcode4 asc";
											$cr_rst1 = mysql_query($cr_qry1);

											$cr_num1 = 1;
											$option ="";
											while($cr_row1 = mysql_fetch_assoc($cr_rst1)):
												$selectValueInput = $cr_row1['lvcode2'];
				
												if($selectValueInput == $board_row2['category'])
												{
													$option.= "<option value=$selectValueInput selected>{$cr_row1['comment']}";
												} else 
												{
													$option.= "<option value=$selectValueInput >{$cr_row1['comment']}";
												}
												//$area_name = codebasename($cr_row1[lvcode1]);
												//$tour_area_value2 = $cr_row1[lvcode1].$cr_row1[lvcode2].$cr_row1[lvcode3].$cr_row1[lvcode4];
												//echo $option;
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td><input name="user_name" type="text" class="form-control" style="width:200px;" value="<?= $board_row2['name'] ?>"></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										  <td height="25" align="center" bgcolor="#FBFBFB">제목 </td>
										  <td  align="left"><input name="title" type="text" class="form-control" value='<?= $board_row2['title'] ?>'></td>
											 
										</tr>
										<tr bgcolor="#FFFFFF"> 
										  <td height="25" align="center" bgcolor="#FBFBFB">내용 </td>
										  <td  align="center"><textarea name="FCKeditor1" id ="FCKeditor1"  class="form-control js-specialBenefit js-ckEditor" ><?=$board_row2['content']?></textarea>
											</td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<!-- 여기에 userfile3, userfile4 추가 (모든 게시판에서 사용) -->
										<tr bgcolor="#FFFFFF"> 
										  <td height="25" align="center" bgcolor="#FBFBFB">첨부파일 </td>
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile3'] ?>&nbsp;<input type=checkbox name=photo_del3 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile4'] ?>&nbsp;<input type=checkbox name=photo_del4 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile5'] ?>&nbsp;<input type=checkbox name=photo_del5 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile6'] ?>&nbsp;<input type=checkbox name=photo_del6 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile7'] ?>&nbsp;<input type=checkbox name=photo_del7 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile8'] ?>&nbsp;<input type=checkbox name=photo_del8 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile9'] ?>&nbsp;<input type=checkbox name=photo_del9 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
										...
										<tr bgcolor="#FFFFFF"> 
										  ...
										  <td colspan="3" align="left"><table width="98%" border="0" cellspacing="0" cellpadding="0">
											  <tr> 
												<td>현재 파일 : <?= $board_row2['userfile10'] ?>&nbsp;<input type=checkbox name=photo_del10 value="1">(※ 첨부파일 삭제)</td>
											  </tr>
											</table></td>
										</tr>
										<tr bgcolor="#FFFFFF"> 
