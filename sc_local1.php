...
;
 ...
 <?php  
		if (($user_dbinfo['dept_prior'] == "J") || ($user_dbinfo['dept_prior'] == "")) {
		    //$deptqry = " && ((c.m_dept like '%$user_dbinfo[area_comp]%') ||  (c.m_dept='')  || (c.p_dept like '%$user_dbinfo[area_comp]%'))";
		} else {
		    $deptqry = "";
		}

		
		$deptqry1 = " && ((b.m_dept like '%$dept%'))";
			...
			//echo $totalDay;
						...
						for($k=0; $k<$totalDay; $k++)
						{
			               ...
			               // echo $choose_date."|".$hotel_qty."|".$zip_row1[p_name]."<br>";	
							$content .= "<td height=35 style='width:10px !important;border:0.05em solid #848484;' align=center bgcolor=$bgcolor title='호텔 : ".$hotel_qty1."'>$block_content</font></td>";
							$hotel_qty1="";
						...
						echo "<tr >
						<td align=left  style='border:0.05em solid #848484;' class='sticky-col first-col'><font style='font-size:8pt'>&nbsp;{$zip_row1['p_code']}<br/><b>&nbsp;{$zip_row1['p_name']}</b></font></td>
						$content
						</tr>";
